...
<path class="text-primary" d="M62.0254 15.4219H64.418V18H62.0254V15.4219Z" transform="translate(0 -3)" fill="#9A6EE2"/>
                  ...
                  <div class="dropdown-menu dropdown-menu-animated dropdown-menu-end p-4" aria-labelledby="cartdetails">
                    <div class="navbar-cart-product-wrapper">
                      ...
                      <div class="navbar-cart-product">
                        <div class="d-flex align-items-center"><a href="detail.html"><img class="img-fluid navbar-cart-product-image" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/product/product-square-ian-dooley-347968-unsplash.jpg" alt="..."></a>
                      ...
                      <!-- cart item-->
                      <div class="navbar-cart-product">
                        <div class="d-flex align-items-center"><a href="detail.html"><img class="img-fluid navbar-cart-product-image" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/product/product-square-kyle-loftus-596319-unsplash.jpg" alt="..."></a>
                          <div class="w-100"><a class="navbar-cart-product-close" href="#"><i class="fa fa-times">                                                   </i></a>
    ...
    <section class="mh-full-screen">
      ...
      <div class="owl-carousel owl-theme circle-slider">
        <div class="item d-flex align-items-end bg-gray-100 light-overlay light-overlay-md-0" style="padding-top: 80px;">
          <div class="container circle-slider-bg" style="background: right bottom url(https://d19m59y37dris4.cloudfront.net/sell/2-0/img/slider/circle-slider-3.jpg) no-repeat; ">
            <div class="w-100">
              <div class="row py-5">
                <div class="col-lg-8 py-md-5 py-lg-7 overlay-content">
                  <h5 class="text-uppercase text-danger mb-3 letter-spacing-5"> Special</h5>
                  <h2 class="mb-3">Ethnic blouses</h2>
                  <p class="lead mb-4">Lorem ipsum dolor sit amet.<br>Consectetur adipisicing elit.</p>
                  <p> <a class="btn btn-outline-dark" href="category.html">View collection</a></p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="item d-flex align-items-end bg-gray-100 light-overlay light-overlay-md-0" style="padding-top: 80px;">
          <div class="container circle-slider-bg" style="background: left bottom url(https://d19m59y37dris4.cloudfront.net/sell/2-0/img/slider/circle-slider-2.jpg) no-repeat;">
            <div class="w-100">
              <div class="row py-5">
                <div class="col-lg-6 py-md-5 py-lg-7 ms-lg-auto text-md-end overlay-content">
                  <h5 class="text-uppercase text-info mb-3 letter-spacing-5"> Just arrived</h5>
                  <h2 class="mb-3">Tigerrrs College Jackets</h2>
                  <p class="lead mb-4">Lorem ipsum dolor sit amet.<br>Consectetur adipisicing elit.</p>
                  <p> <a class="btn btn-outline-dark" href="category.html">View collection                            </a></p>
                </div>
              </div>
        ...
        <div class="item d-flex align-items-end bg-gray-100 light-overlay light-overlay-md-0" style="padding-top: 80px;">
          <div class="container circle-slider-bg" style="background: right bottom url(https://d19m59y37dris4.cloudfront.net/sell/2-0/img/slider/circle-slider-1.jpg) no-repeat; ">
            <div class="w-100">
              <div class="row py-5">
                <div class="col-lg-8 py-md-5 py-lg-7 overlay-content">
                  <h5 class="text-uppercase text-muted mb-3 letter-spacing-5"> Special</h5>
                  <h2 class="mb-3">Autumn-colour coats</h2>
                  <p class="lead mb-4">Lorem ipsum dolor sit amet.<br>Consectetur adipisicing elit.</p>
                  <p> <a class="btn btn-outline-dark" href="category.html">View collection</a></p>
                </div>
              </div>
    ...
    <section class="py-6">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4 mb-4 mb-md-6 pt-lg-3"><a href="detail-2.html"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/product/artboard-bag.jpg" alt=""></a>
            <div class="px-4 position-relative z-index-2 mt-n3"><a class="text-dark text-decoration-none" href="detail-2.html">
          ...
          <div class="col-md-7 ms-auto mb-4 mb-md-5">
            <div class="position-absolute z-index-5 py-6"><a class="text-dark text-decoration-none" href="detail.html">
                <h2>Sweaters<br>for<br>her     </h2>
                <p class="text-muted">$39.90</p></a>
              <p> <a class="btn btn-link text-dark text-decoration-none px-0" href="detail.html"> Shop now      </a></p>
            </div>
            <div class="ms-6"><a href="detail.html"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/photo/matthew-kane-365718-unsplash-gray-square.jpg" alt=""></a></div>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-7 mb-4 mb-lg-5">
            ...
            <div class="ms-6"><a href="detail-2.html"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/photo/ian-dooley-347968-unsplash.jpg" alt=""></a></div>
          </div>
          <div class="col-lg-4 ms-auto pt-lg-6 mb-4 mb-lg-5"><a class="text-dark text-decoration-none" href="detail.html"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/product/artboard-sunglasses.jpg" alt=""></a>
            <div class="px-4 position-relative z-index-2 mt-n3"><a class="text-dark text-decoration-none" href="detail.html">
        ...
        <div class="row">
          <div class="col-lg-3 pt-lg-3 mb-4 mb-lg-5"><a href="detail-2.html"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/product/artboard-watch.jpg" alt=""></a>
            <div class="px-4 position-relative z-index-2 mt-n3"><a class="text-dark text-decoration-none" href="detail-2.html">
          ...
          <div class="col-lg-8 ms-auto">
            ...
            <div class="ms-6"><a href="detail.html"><img class="img-fluid" src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/photo/serrah-galos-494279-unsplash-square.jpg" alt=""></a></div>
          </div>
        </div>
      </div>
    </section>
    <section class="bg-danger">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6" style="background: right bottom url(https://d19m59y37dris4.cloudfront.net/sell/2-0/img/photo/sale-circle.jpg) no-repeat; background-size: contain;"></div>
        </div>
      </div>
    </section>
    <section class="py-6">
      <div class="container">
        <div class="row">
          <div class="col-xl-8 mx-auto text-center mb-5">
            <h3 class="text-uppercase">Last viewed products</h3>
          </div>
        </div>
        <!-- Products Slider-->
    ...
    <div class="collapse" id="style-switch">
      <div class="p-3">
        <h6 class="text-uppercase mb-4">Choisis theme colour</h6>
        <form class="mb-3">
          <select class="form-select style-switch-select" name="colour" id="colour">
            <option value="">select colour variant</option>
            <option value="css/style.default.0f4f85c6.css">blue</option>
            <option value="css/style.pink.4590158a.css">pink</option>
            <option value="css/style.green.fbc772a1.css">green</option>
            <option value="css/style.red.16dca32f.css">red</option>
            <option value="css/style.violet.3e468878.css">violet</option>
          </select>
        </form>
